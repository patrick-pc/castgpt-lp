...
export default function NavBar() {
  return (
    <nav className="absolute top-0 left-0 w-full flex items-center justify-between py-2 px-4 bg-black/80">
      <Link href="/">
        <div className="flex items-center justify-center gap-6">
          ...
          <div className="font-medium text-sm">CastGPT</div>
        </div>
      </Link>

      <div className="flex items-center justify-center gap-3">
        <Image src="/favicon.png" alt="CastGPT Icon" width={14} height={14} />
